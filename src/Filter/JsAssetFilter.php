    ...
    protected function obfuscate(AssetInterface $asset): self
    {
        ...
        if ($this->jsObfuscatorBin) {
            ...
            $jsObfuscatorArgs =
                ...
                '--compact true --control-flow-flattening false --dead-code-injection false --debug-protection false --debug-protection-interval false --disable-console-output false --log false --rename-globals false --rotate-string-array true --self-defending true --string-array true --string-array-encoding false --string-array-threshold 0.75 --unicode-escape-sequence false';
